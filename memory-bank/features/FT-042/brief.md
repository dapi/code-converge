...
- `REQ-03` Document-review mode reviews only changed Markdown files in the current merge-base-to-worktree snapshot, excludes `memory-bank/prompts/**`, and reports a clean, explicit empty scope without invoking Codex when none remain.
