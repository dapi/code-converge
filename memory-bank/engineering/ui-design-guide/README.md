...
doc_function: index
purpose: Records that project-level UI design references do not apply to the current CLI-only reviewer product.
derived_from:
  - ../../dna/governance.md
  - ../frontend.md
  - ../../../README.md
...
N/A. `reviewer` has no graphical UI, UI kit, surface-specific components, screenshots, or frontend source paths. The current user interface is the CLI contract documented in the root [`README.md`](../../../README.md); frontend applicability is owned by [`../frontend.md`](../frontend.md).
