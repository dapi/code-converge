...
| Codex boundary (`internal/codex`) | Schema-constrained review invocation with a prepared review target and remediation invocation | Deterministic Git/GitHub lifecycle decisions, exit-code policy, and workflow stdout formatting |
