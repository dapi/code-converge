...
| Process runner (`internal/runner`) | Working directory, context cancellation, captured stdin/stdout/stderr, exit status and private-stage context | Agent-report interpretation |
