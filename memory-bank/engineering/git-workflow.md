...
purpose: Confirmed reviewer Git branch and verification expectations, with unspecified policies made explicit.
derived_from:
  - ../dna/governance.md
  - testing-policy.md
  - ../../README.md
...
- When the target repository has applicable required CI, the `reviewer` workflow treats its green result as part of successful finalization. When it does not, the CI step is not applicable. Branch protection and required-check configuration belong to the target repository and hosting provider.
