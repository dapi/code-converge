...
| Stage duration | Wall duration of a completed stage | `duration_ms` in `kv`; readable duration in human output | Measures review, fixing, publication, CI polling, and CI-recovery cost. |
