...
- [`PRD-001: Code-Converge CLI`](PRD-001-code-converge-cli.md) — продуктовая проблема, users/jobs, полный scope, success metrics, risks и единая delivery-unit законченной CLI-утилиты.
