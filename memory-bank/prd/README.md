...
- [`PRD-001: Reviewer CLI`](PRD-001-reviewer-cli.md) — продуктовая проблема, users/jobs, полный scope, success metrics, risks и единая delivery-unit законченной CLI-утилиты.
